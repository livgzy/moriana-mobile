...
class _PromoAddScreenState extends State<PromoAddScreen> {
  ...
  bool isTypeFood = true; 

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Tambah Promo", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),),
        centerTitle: true,
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text("Promo berhasil Disimpan!", style: TextStyle(color: Colors.white)),backgroundColor: Colors.green,),
                  );

                  final createPromo = PromotionModel(
                  ...
                  await FirestoreService().addPromo(createPromo);
